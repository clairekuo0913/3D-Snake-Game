                ...
                if(CubeSurface.gameObject.name == "pos_x"){
                    ...
                    if(dv.magnitude > dh.magnitude){
                        if(dv.normalized == scrn_yAxis.normalized){
                            Cube.GetComponent<Snake>().Rotate("down");
                        }else{
                            Cube.GetComponent<Snake>().Rotate("up");
                        }
                    }else if(dv.magnitude < dh.magnitude){
                        if(dh.normalized == scrn_zAxis.normalized){
                            Cube.GetComponent<Snake>().Rotate("right");
                        }else{
                            Cube.GetComponent<Snake>().Rotate("left");
                        }
                    }
                    ...
                    if(dv.magnitude > dh.magnitude){
                        if(dv.normalized == scrn_xAxis.normalized){
                            Cube.GetComponent<Snake>().Rotate("clockwise");
                        }else{
                            Cube.GetComponent<Snake>().Rotate("counterClockwise");
                        }
                    }else if(dv.magnitude < dh.magnitude){
                        if(dh.normalized == scrn_zAxis.normalized){
                            Cube.GetComponent<Snake>().Rotate("up");
